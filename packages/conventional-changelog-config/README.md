...
<p align="center">Beautiful changelog based on Aron's conventional commits</p>
...
<p align="center">
    ...
    <a aria-label="NPM Package" href="https://www.npmjs.com/package/conventional-changelog-aron">
        <picture>
            <source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/npm/dm/conventional-changelog-aron?color=212022&label=%20&logo=npm&style=for-the-badge">
            <source media="(prefers-color-scheme: light)" srcset="https://img.shields.io/npm/dm/conventional-changelog-aron?color=f6f7f8&label=%20&logo=npm&style=for-the-badge">
            <img alt="NPM package ( download / month )" src="https://img.shields.io/npm/dm/conventional-changelog-aron?color=f6f7f8&label=%20&logo=npm&style=for-the-badge">
        </picture>
    </a>
...
```
This package is used with [Aron's semantic release](https://github.com/1aron/aronrepo/blob/beta/packages/semantic-release-config/configure.js).


## Generated Example
https://github.com/master-co/css/releases/tag/v2.0.0-beta.77

<img width="1265" alt="changelog-example" src="https://user-images.githubusercontent.com/33840671/205967240-d7a4f425-439c-4222-8c10-778f76f5540e.png">
...
```
For full documentation, check out the [Aron's conventional commits](https://github.com/1aron/aronrepo/packages/conventional-commits)
