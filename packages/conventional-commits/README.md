...
| None | `Docs`, `Example`, `Test`, `Refactor`, `Chore`, `Misc` |
...
Those examples create releases for internal policy-only changes. Use `Chore(Agent)` unless published behavior changes.
