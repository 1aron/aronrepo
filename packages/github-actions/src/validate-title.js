...
module.exports = async function validateTitle(title) {
    ...
    if (!result.type) {
        throw new Error(
            ...
            '\n\nAdd a prefix like "Fix: ", "Feat: " to indicate what kind of release this pull request corresponds to. The title should match the commit mesage format as specified by https://github.com/1aron/aronrepo/packages/conventional-commits.'
        )
    }
