...
Typically, you would use [Aron's semantic release](https://github.com/1aron/packages/semantic-release-config) with CI to automate the version and release commands.
...
Next, check out the [Aron's semantic release](https://github.com/1aron/packages/semantic-release-config)
